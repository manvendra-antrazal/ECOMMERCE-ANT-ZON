...
public class Message {
    ...
    public static final String NUMBER = "Please enter a valid number.";
    ...
    public static final String CATEGORY_ID = "Enter Category ID: ";
    public static final String SUB_CATEGORY_ID = "Enter Sub-Category ID: ";
    ...
    public static final String FAILED_CLEAR_CART = "Failed to clear cart.";
    ...
    public static final String FAILED_UPDATE_PRODUCT = "Faield to update product.";
    ...
    public static final String UPDATE_FAILED = "Error occurred while updating. Please try again.";
    ...
    public static final String ENTER_NEW_SELLER_PASSWORD = "Enter new password: ";
    ...
    public static final String ERROR_VIEW_TOTAL = "Failed to fetch total.";
    ...
    public static final String ERROR_GET_TOTAL  = "Getting total failed.";
    public static final String ERROR_VIEW_SELLER = "Failed fetching seller product.";
    ...
    public static final String FAILED_UPDATE_STOCK = "Failed to update stock";
    ...
    public static String FAILED_TO_UPDATE_STOCK;
    public static String FAILED_TO_ADD_PRODUCT;
    public static String FAILED_TO_REGISTER;
    public static String PRODUCT_REQUIRED = "Product name is required";
    public static String PRODUCT_PRICE_REQUIRED = "Product price cannot be required";
    public static String PRODUCT_QUANTITY_REQUIRED = "Product quantity cannot be required";
    public static String COMPANY_NAME_REUIQURED = "Company ID is required";
    public static String SELLER_ID_REQUIRED  = "Seller ID is required";
