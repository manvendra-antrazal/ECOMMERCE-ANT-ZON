...
public class Queries {
    ...
    public static final String INSERT_ADMIN_QUERY = 
        "INSERT INTO company (company_name, company_login, company_psd) VALUES (?, ?, ?)"; 
    ...
    // Check existence: count by username
    public static final String CHECK_BUYER_EXISTS =
        "SELECT COUNT(*) FROM buyer WHERE username = ?";

    // Minimal insert (username, password). If your schema needs more fields, expand accordingly.
    public static final String INSERT_NEW_BUYER =
